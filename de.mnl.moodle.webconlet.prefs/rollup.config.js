...
let module = "build/generated/resources/de/mnl/moodle/webconlet/prefs/MoodlePrefs-functions.js"
...
let pathsMap = {
    ...
    "l10nBundles": "./MoodlePrefs-l10nBundles.ftl.js"
}

export default {
  external: ['vue', 'aash-plugin', 'jgconsole', 'jgwc', 'l10nBundles'],
  input: "src/de/mnl/moodle/webconlet/prefs/browser/MoodlePrefs-functions.ts",
  output: [
    {
      format: "esm",
      file: module,
