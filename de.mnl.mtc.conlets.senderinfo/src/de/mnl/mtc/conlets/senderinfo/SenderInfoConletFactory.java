...
/**
 * The factory service for {@link SenderInfoConlet}s.
 */
@org.osgi.service.component.annotations.Component(
    scope = ServiceScope.SINGLETON)
public class SenderInfoConletFactory implements ConletComponentFactory {
    ...
    public Optional<ComponentType> create(
        ...
        return Optional.of(new SenderInfoConlet(componentChannel));
    }
