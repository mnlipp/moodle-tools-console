...
/**
 * The factory service for {@link AccountConlet}s.
 */
@org.osgi.service.component.annotations.Component(
    scope = ServiceScope.SINGLETON)
public class AccountConletFactory implements ConletComponentFactory {
    ...
    public Optional<ComponentType> create(
        ...
        return Optional.of(new AccountConlet(componentChannel));
    }
