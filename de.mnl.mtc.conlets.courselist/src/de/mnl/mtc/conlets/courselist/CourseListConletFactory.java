...
/**
 * The factory service for {@link CourseListConlet}s.
 */
@org.osgi.service.component.annotations.Component(
    scope = ServiceScope.SINGLETON)
public class CourseListConletFactory implements ConletComponentFactory {
    ...
    public Optional<ComponentType> create(
        ...
        return Optional.of(new CourseListConlet(componentChannel));
    }
